        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <button
              ...
              className={`p-4 rounded-lg border-2 transition-all ${selectedRole === 'partner'
            ...
            <button
              ...
              className={`p-4 rounded-lg border-2 transition-all ${selectedRole === 'manager'
                ? 'border-blue-500 bg-blue-50 text-blue-700'
                : 'border-gray-200 hover:border-gray-300 text-gray-700'
                }`}
            >
          ...
          <div className="grid grid-cols-1 gap-4 mb-6">
            ...
            <button
              ...
              className={`p-4 rounded-lg border-2 transition-all ${selectedRole === 'staff'
                ? 'border-blue-500 bg-blue-50 text-blue-700'
                : 'border-gray-200 hover:border-gray-300 text-gray-700'
                }`}
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-blue-600 text-white py-2 px-4 rounded-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center font-semibold"
            >
              {isLoading ? (
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 text-center">
            ...
            <button
              ...
              className="w-full flex items-center justify-center space-x-2 bg-white border-2 border-blue-600 text-blue-600 py-2.5 rounded-lg hover:bg-blue-50 transition-all font-bold group shadow-sm"
            >
