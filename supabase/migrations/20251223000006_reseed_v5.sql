...
BEGIN
    ...
    -- 3. Insert Auth User (EXPLICIT FIELDS)
    -- Setting instance_id to '0000...' which is standard, and aud/role to 'authenticated'
    INSERT INTO auth.users (id, instance_id, email, encrypted_password, email_confirmed_at, aud, role)
    VALUES (
        partner_id, 
        '00000000-0000-0000-0000-000000000000',
        admin_email, 
        '$2b$10$dd979qV8jJw4.ZwgBthSkeCs/gne76wB74mHwNrzeU2zkraFqDOpy', 
        now(),
        'authenticated',
        'authenticated'
    );
    ...
    VALUES (partner_id, demo_firm_id, admin_email, 'admin', 'placeholder', 'Rajesh Sharma', 'partner', '+91 98765 43210');
    
    RAISE NOTICE 'Reseed V5 Complete';
END $$;
